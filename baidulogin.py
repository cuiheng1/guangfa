...
def emulateLoginBaidu():
    ...
    if(foundTokenVal):
        ...
        postDict = {
            ...
            'username'      : 'cuilang3@163.com',
            'password'      : 'dmEn4K5asSmW9868Q9Lo+7llnvmCMAkgR3pbEea+4eMcE92f2Cmz2UiMb8psIZ35eFXbyfv7lSL+QJYTlSneX266e0wU9LNqzrTH9uzvQYvzMduXBTUl4/ncc9GaDcLFvlmiXDHnYdLcF27bRZ5EfFykuDATKJZnR0XcaIuzOY4=',
            #'verifycode'    : "",
            'mem_pass'      : "on",
        };
